...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *NestChecksAndBalances*):

Restore dependencies
```
    cd "NestChecksAndBalances"
    dotnet restore
```

Execute unit tests
```
    cd "NestChecksAndBalances/test/NestChecksAndBalances.Tests"
    dotnet test
```

Deploy application
```
    cd "NestChecksAndBalances/src/NestChecksAndBalances"
